...
setup(name=NAME, version="2.3.0", author='SRCE', author_email='dvrcic@srce.hr',
      ...
      package_dir={'argo_connectors.io': 'modules/io', 'argo_connectors.parse':
                   'modules/parse', 'argo_connectors.mesh': 'modules/mesh',
                   'argo_connectors.tasks': 'modules/tasks', 'argo_connectors':
                   'modules/'},
