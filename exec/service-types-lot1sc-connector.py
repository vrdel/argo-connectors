...
def main():
    conn_exec = ExecConnector(
        description="Fetch service types from LOT1 Service Catalogue and send it to WEB-API",
        initial_arg=True,
    ...
    try:
        task = TaskLot1ScServiceTypes(conn_exec.fixed_date, conn_exec.args.initsync)
